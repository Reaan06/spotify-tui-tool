...
class HelpView(Widget):
    ...
    KEYBINDINGS = [
        ...
        ("Down", "Move down", "Navigation"),
        ("Up", "Move up", "Navigation"),
        ("h", "Move left", "Navigation"),
        ("l", "Move right", "Navigation"),
        ("Left/Right", "Move between regions", "Navigation"),
        ("Esc", "Close the active transient screen", "System"),
        ("q", "Back from transient screen or quit", "System"),
        ("?", "Help", "System"),
    ]
